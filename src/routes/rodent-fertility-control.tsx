...
function ProgramPage() {
  return (
    <>
      ...
      <ClosingCta
        title="Start the managed program."
        body="Tell us about your property and who handles pest control now. We'll coordinate Phase 1 with your vendor and run the fertility management layer with monthly maintenance."
