...
export const atlasSources: AtlasSource[] = [
  ...
  {
    id: "oakland-311-service-requests",
    name: "Oakland 311 service requests",
    url: OAKLAND_311_SOURCE_URL,
    owner: "City of Oakland",
    sourceType: "official-open-data",
  },
  {
    id: "san-jose-311-service-requests",
    name: "San Jose 311 service request data",
    url: SAN_JOSE_311_SOURCE_URL,
    owner: "City of San Jose",
    sourceType: "official-open-data",
  },
  {
    id: "jersey-city-open-data",
    name: "Jersey City Open Data",
    url: JERSEY_CITY_OPEN_DATA_URL,
...
export const watchlistPlaces: WatchlistPlace[] = [
  {
    placeId: "jersey-city",
    reason: "Jersey City is a priority NJ market, but no clean citywide rodent complaint or inspection feed has been confirmed for the atlas yet.",
  ...
  {
    placeId: "oakland",
    reason: "Oakland is a priority Bay Area market, but the reviewed 311 source has not yet been confirmed to expose clean rodent/vermin categories for public activity dots.",
    reviewedSourceName: "Oakland 311 service requests",
    reviewedSourceUrl: OAKLAND_311_SOURCE_URL,
    reviewedOn: "2026-05-25",
    reviewNote: "Potential context layers include dumping, trash, and code-enforcement signals. Rodent Activity needs a verified rodent/vermin filter first.",
  },
  {
    placeId: "san-jose",
    reason: "San Jose is a priority Bay Area market, but no clean rodent/vermin 311 category has been confirmed in the current atlas source review.",
    reviewedSourceName: "San Jose 311 service request data",
    reviewedSourceUrl: SAN_JOSE_311_SOURCE_URL,
    reviewedOn: "2026-05-25",
    reviewNote: "Use as a Bay Area data gap until the 311 taxonomy or another official health/code source proves an auditable rodent-related filter.",
  },
  {
    placeId: "philadelphia",
    reason: "Philadelphia publishes 311 service & information requests via OpenDataPhilly, but the public_cases_fc service_name field does not include a dedicated rodent/rat/vermin service type usable as an official activity layer.",
